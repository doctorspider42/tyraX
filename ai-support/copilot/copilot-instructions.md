...
builds with native PS2DEV/OpenVCL by default and runs in PCSX2. Docker is an optional fallback.
...
The first native build provisions and verifies the toolchain automatically; output lands in
