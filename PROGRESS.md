...
- (107) **Real 3D memory card icons - including ANIMATED ones from .glb
  clips.** (106)'s flat textured quad grows into a proper icon pipeline
  ...
  card").
- (106) **Save Editor, memory card identity (icon.sys + 3D icon), checkpoints,
