...
- (85) **Merge-friendly project format: one file per object + collaboration
  scaffolding (steps 2-4, building on the ids in entry 84).** The whole point of
...
- (84) **Stable object ids (step 1 of the merge-friendly project format).**
