...
- (113) **NavMesh + NPC AI — Patrol / Chase / Flee / On Player Seen.** NPCs
...
- (99) **Reflective materials: sphere-mapped "chrome" (the NFS/GT car-paint
  ...
  *(Numbering note: the reflective-materials series above landed as its own
  ...
  — a merge on main also left conflict markers in this file, repaired here.
  Old entries keep their numbers; the sequence continues from (113).)*
