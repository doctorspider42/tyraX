...
constexpr float WALK_SPEED = 0.16F;
...
constexpr float SPRINT_SPEED = 0.288F;
...
constexpr float ANIM_LOD_DISTANCE = 12.0F;
...
constexpr float MESH_LOD_DISTANCE = 18.0F;
...
constexpr bool DEBUG_SHOW_PROFILER = true;
