...
class StaPipQBufferRenderer {
 ...
 private:
  ...
  void ensurePacketCapacity(const u16& requiredQwords);
  ...
  bool submissionPacketIsBatch = false;
  bool currentBatchBagHasGeometry = false;
  bool currentBatchBagTextured = false;
