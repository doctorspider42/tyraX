...
constexpr SceneObjectData SCENE_0_OBJECTS[3] = {
    {6, {0.0F, 14.0F, 0.0F}, {0.0F, 0.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {0.15F, 0.9F, 0.9F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0, 1.0F, 8.0F, 0, 0.0F, 0, 25.0F, 0, 0, 0, 0.0F, 0, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 0, 16, 0, -1, 0, {0.0F, 0.0F, 0.0F, 0.0F}},  // player-1
    {18, {0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F}, {42.0F, 4.0F, 42.0F}, {0.9F, 0.5F, 0.5F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0, 1.0F, 8.0F, 0, 0.0F, 0, 25.0F, 0, 0, 2, 0.0F, 0, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 0, 16, 0, -1, 0, {0.0F, 0.0F, 0.0F, 0.0F}},  // the-cube
    {11, {0.0F, 1.0F, 0.0F}, {0.0F, 0.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {0.9F, 0.6F, 0.2F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0, 1.0F, 8.0F, 0, 0.0F, 0, 25.0F, 0, 0, 0, 0.0F, 0, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 0, 16, 0, -1, 0, {0.0F, 0.0F, 0.0F, 0.0F}},  // shuffler
};
...
constexpr unsigned long long SCENE_0_OBJECT_ID_HASHES[3] = {0x1cc32e3bb4d3f565ULL, 0x5c93abae1f067ce0ULL, 0x5c97abae1f0a65b7ULL};
...
constexpr float TERRAIN_WIDTHS[SCENE_COUNT] = {80.0F};
constexpr float TERRAIN_DEPTHS[SCENE_COUNT] = {80.0F};
...
constexpr float SKY_BS[SCENE_COUNT] = {7.65F};
constexpr bool SKY_DOMES[SCENE_COUNT] = {false};
constexpr float SKY_ZENITH_EXPS[SCENE_COUNT] = {1.0F};
constexpr float SKY_TOP_RS[SCENE_COUNT] = {0.0F};
constexpr float SKY_TOP_GS[SCENE_COUNT] = {0.0F};
constexpr float SKY_TOP_BS[SCENE_COUNT] = {2.55F};
