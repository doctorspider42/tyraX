...
constexpr float HM_ORIGIN_XS[SCENE_COUNT] = {-40.0F};
constexpr float HM_ORIGIN_ZS[SCENE_COUNT] = {-40.0F};
constexpr float HM_STEP_XS[SCENE_COUNT] = {2.5F};
constexpr float HM_STEP_ZS[SCENE_COUNT] = {2.5F};
