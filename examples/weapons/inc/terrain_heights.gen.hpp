...
constexpr float HM_ORIGIN_XS[SCENE_COUNT] = {-28.0F};
constexpr float HM_ORIGIN_ZS[SCENE_COUNT] = {-28.0F};
constexpr float HM_STEP_XS[SCENE_COUNT] = {1.75F};
constexpr float HM_STEP_ZS[SCENE_COUNT] = {1.75F};
