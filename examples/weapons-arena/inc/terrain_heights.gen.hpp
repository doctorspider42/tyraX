...
constexpr float HM_ORIGIN_XS[SCENE_COUNT] = {-36.0F};
constexpr float HM_ORIGIN_ZS[SCENE_COUNT] = {-36.0F};
constexpr float HM_STEP_XS[SCENE_COUNT] = {2.25F};
constexpr float HM_STEP_ZS[SCENE_COUNT] = {2.25F};
