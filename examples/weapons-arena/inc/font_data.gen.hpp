...
inline const DynTextData DYN_TEXTS[DYN_TEXT_COUNT > 0 ? DYN_TEXT_COUNT : 1] = {
    {0, 0.16F, 0.93F, 16.0F},  // scene 0, object 0, node 3
    {0, 0.5F, 0.93F, 16.0F},  // scene 0, object 0, node 5
    {0, 0.85F, 0.93F, 16.0F},  // scene 0, object 0, node 7
    {0, 0.5F, 0.45F, 22.0F},  // scene 0, object 0, node 9
};
