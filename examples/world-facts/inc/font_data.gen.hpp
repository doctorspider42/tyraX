...
constexpr int DYN_TEXT_COUNT = 20;
constexpr int DYN_TEXT_LEN = 64;  // per-slot string buffer
inline const DynTextData DYN_TEXTS[DYN_TEXT_COUNT > 0 ? DYN_TEXT_COUNT : 1] = {
    {0, 0.5F, 0.82F, 16.0F},  // scene 0, object 5, node 6
    {0, 0.5F, 0.82F, 16.0F},  // scene 0, object 5, node 16
    {0, 0.5F, 0.82F, 16.0F},  // scene 0, object 5, node 21
    {0, 0.5F, 0.82F, 16.0F},  // scene 0, object 5, node 22
    {0, 0.5F, 0.14F, 16.0F},  // scene 0, object 6, node 6
    {0, 0.5F, 0.14F, 16.0F},  // scene 0, object 6, node 10
    {0, 0.5F, 0.14F, 16.0F},  // scene 0, object 6, node 13
    {0, 0.5F, 0.2F, 16.0F},  // scene 0, object 6, node 15
    {0, 0.5F, 0.08F, 16.0F},  // scene 0, object 8, node 4
    {0, 0.5F, 0.4F, 18.0F},  // scene 0, object 8, node 8
    {0, 0.5F, 0.26F, 16.0F},  // scene 0, object 9, node 8
    {0, 0.5F, 0.32F, 16.0F},  // scene 0, object 9, node 24
    {0, 0.5F, 0.32F, 16.0F},  // scene 0, object 9, node 28
    {0, 0.5F, 0.32F, 16.0F},  // scene 0, object 9, node 29
    {0, 0.5F, 0.02F, 16.0F},  // scene 0, object 11, node 9
