...
const int NODES = 44;      // instrumented flow-graph nodes
const int VARS = 9;        // watch slots: flow variables + save values
...
const unsigned int HASH_LO = 2463781942U, HASH_HI = 334851641U;
