...
const int NODES = 82;      // instrumented flow-graph nodes
const int VARS = 10;        // watch slots: flow variables + save values
...
const unsigned int HASH_LO = 4257513251U, HASH_HI = 4065851915U;
