...
const int NODES = 108;      // instrumented flow-graph nodes
const int VARS = 16;        // watch slots: flow variables + save values
...
const unsigned int HASH_LO = 3276259692U, HASH_HI = 2346107923U;
