...
const int NODES = 41;      // instrumented flow-graph nodes
const int VARS = 2;        // watch slots: flow variables + save values
const int FLOW_VARS = 1;  // how many of those are flow variables
...
const unsigned int HASH_LO = 1827092662U, HASH_HI = 1905717703U;
