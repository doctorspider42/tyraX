...
constexpr SceneObjectData SCENE_0_OBJECTS[14] = {
    {6, {0.0F, 0.0F, 0.0F}, {-1.14962e-06F, 0.49807F, -4.75818e-05F}, {0.999996F, 1.0F, 0.999996F}, {0.15F, 0.9F, 0.9F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 0},  // player-1
    {9, {-5.0F, 2.4F, 6.0F}, {0.0F, 0.0F, 0.0F}, {0.4F, 0.4F, 0.4F}, {1.0F, 0.58F, 0.22F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.3F, 11.0F, 1, 0.45F, 2, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 0},  // torch-left
    {9, {5.0F, 2.4F, 6.0F}, {0.0F, 0.0F, 0.0F}, {0.4F, 0.4F, 0.4F}, {1.0F, 0.62F, 0.25F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.25F, 11.0F, 1, 0.35F, 2, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 0},  // torch-right
    {9, {-2.5F, 1.4F, 11.0F}, {0.0F, 0.0F, 0.0F}, {0.4F, 0.4F, 0.4F}, {0.35F, 0.75F, 1.0F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0.95F, 6.0F, 1, 0.0F, 1, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 0},  // crystal
    {9, {10.0F, 2.6F, 13.0F}, {0.0F, 0.0F, 0.0F}, {0.4F, 0.4F, 0.4F}, {0.4F, 0.6F, 1.0F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.5F, 8.0F, 0, 0.0F, 1, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 0},  // lamp-baked
    {0, {0.0F, 1.6F, 16.0F}, {0.0F, 18.0F, 0.0F}, {1.6F, 3.2F, 0.9F}, {0.55F, 0.5F, 0.6F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 1, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 1, -1, 1},  // monolith
    {1, {-6.0F, 1.1F, 13.0F}, {0.0F, 0.0F, 0.0F}, {1.4F, 1.4F, 1.4F}, {0.85F, 0.8F, 0.7F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 1, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 1},  // orb
    {3, {6.0F, 1.25F, 15.0F}, {0.0F, 0.0F, 0.0F}, {1.6F, 2.5F, 1.6F}, {0.7F, 0.55F, 0.45F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 1, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 1},  // obelisk
    {0, {-3.0F, 3.5F, 9.0F}, {0.0F, 25.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {0.6F, 0.45F, 0.3F}, 1, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 1, -1, 0},  // crate-1
    {0, {3.2F, 5.0F, 10.0F}, {0.0F, -15.0F, 0.0F}, {0.8F, 0.8F, 0.8F}, {0.55F, 0.4F, 0.28F}, 1, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 1, -1, 0},  // crate-2
    {0, {-9.0F, 2.0F, 3.0F}, {0.0F, 0.0F, 0.0F}, {1.2F, 4.0F, 1.2F}, {0.5F, 0.5F, 0.55F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 1, -1, 1},  // pillar
    {9, {-1.71486F, 7.35505F, -24.9247F}, {0.0F, -0.0F, 0.0F}, {0.4F, 0.4F, 0.4F}, {1.0F, 0.62F, 0.25F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.09F, 12.1F, 1, 0.35F, 1, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 0},  // torch-right-copy
    {1, {-0.142221F, 0.815477F, -22.3818F}, {0.0F, -0.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {0.168541F, 0.206781F, 0.818627F}, 1, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 1, 1, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 1, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 0},  // sphere-1
    {0, {-1.31827F, 2.78907F, -28.6179F}, {0.0F, -0.0F, 0.0F}, {8.56945F, 6.21425F, 1.0F}, {0.441176F, 0.058391F, 0.058391F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 1, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 1, -1, 1},  // box-1
};
