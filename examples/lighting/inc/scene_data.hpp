...
constexpr SceneObjectData SCENE_0_OBJECTS[11] = {
    {6, {0.0F, 0.0F, -7.0F}, {0.0F, 0.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {0.15F, 0.9F, 0.9F}, 0, -1, -1, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, -1, "", 1, 1, 1.0F, 16, -1},  // player-1
    {9, {-5.0F, 2.4F, 6.0F}, {0.0F, 0.0F, 0.0F}, {0.4F, 0.4F, 0.4F}, {1.0F, 0.58F, 0.22F}, 0, -1, -1, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.3F, 11.0F, 1, 0.45F, 2, 0, 0, 0.0F, 0, 0, -1, "", 1, 1, 1.0F, 16, -1},  // torch-left
    {9, {5.0F, 2.4F, 6.0F}, {0.0F, 0.0F, 0.0F}, {0.4F, 0.4F, 0.4F}, {1.0F, 0.62F, 0.25F}, 0, -1, -1, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.25F, 11.0F, 1, 0.35F, 2, 0, 0, 0.0F, 0, 0, -1, "", 1, 1, 1.0F, 16, -1},  // torch-right
    {9, {-2.5F, 1.4F, 11.0F}, {0.0F, 0.0F, 0.0F}, {0.4F, 0.4F, 0.4F}, {0.35F, 0.75F, 1.0F}, 0, -1, -1, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 0.95F, 6.0F, 1, 0.0F, 1, 0, 0, 0.0F, 0, 0, -1, "", 1, 1, 1.0F, 16, -1},  // crystal
    {9, {10.0F, 2.6F, 13.0F}, {0.0F, 0.0F, 0.0F}, {0.4F, 0.4F, 0.4F}, {0.4F, 0.6F, 1.0F}, 0, -1, -1, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.5F, 8.0F, 0, 0.0F, 1, 0, 0, 0.0F, 0, 0, -1, "", 1, 1, 1.0F, 16, -1},  // lamp-baked
    {0, {0.0F, 1.6F, 16.0F}, {0.0F, 18.0F, 0.0F}, {1.6F, 3.2F, 0.9F}, {0.55F, 0.5F, 0.6F}, 0, -1, -1, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 1, -1, "", 1, 1, 1.0F, 1, -1},  // monolith
    {1, {-6.0F, 1.1F, 13.0F}, {0.0F, 0.0F, 0.0F}, {1.4F, 1.4F, 1.4F}, {0.85F, 0.8F, 0.7F}, 0, -1, -1, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 1, -1, "", 1, 1, 1.0F, 16, -1},  // orb
    {3, {6.0F, 1.25F, 15.0F}, {0.0F, 0.0F, 0.0F}, {1.6F, 2.5F, 1.6F}, {0.7F, 0.55F, 0.45F}, 0, -1, -1, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 1, -1, "", 1, 1, 1.0F, 16, -1},  // obelisk
    {0, {-3.0F, 3.5F, 9.0F}, {0.0F, 25.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {0.6F, 0.45F, 0.3F}, 1, -1, -1, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, -1, "", 1, 1, 1.0F, 1, -1},  // crate-1
    {0, {3.2F, 5.0F, 10.0F}, {0.0F, -15.0F, 0.0F}, {0.8F, 0.8F, 0.8F}, {0.55F, 0.4F, 0.28F}, 1, -1, -1, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, -1, "", 1, 1, 1.0F, 1, -1},  // crate-2
    {0, {-9.0F, 2.0F, 3.0F}, {0.0F, 0.0F, 0.0F}, {1.2F, 4.0F, 1.2F}, {0.5F, 0.5F, 0.55F}, 0, -1, -1, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, -1, "", 1, 1, 1.0F, 1, -1},  // pillar
};
