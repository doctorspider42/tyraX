...
constexpr float DAYCYCLE_STARTS[SCENE_COUNT] = {7.2F, 12.0F, 17.3F, 22.5F, 22.5F};
constexpr float DAYCYCLE_BAKEDS[SCENE_COUNT] = {7.2F, 12.0F, 17.3F, 22.5F, 12.0F};
constexpr float DAYCYCLE_DAYLENS[SCENE_COUNT] = {120.0F, 120.0F, 120.0F, 120.0F, 600.0F};
