...
constexpr int HM_WS[SCENE_COUNT] = {33, 33, 33, 33};
constexpr int HM_DS[SCENE_COUNT] = {33, 33, 33, 33};
constexpr float HM_ORIGIN_XS[SCENE_COUNT] = {-48.0F, -48.0F, -48.0F, -48.0F};
constexpr float HM_ORIGIN_ZS[SCENE_COUNT] = {-48.0F, -48.0F, -48.0F, -48.0F};
constexpr float HM_STEP_XS[SCENE_COUNT] = {3.0F, 3.0F, 3.0F, 3.0F};
constexpr float HM_STEP_ZS[SCENE_COUNT] = {3.0F, 3.0F, 3.0F, 3.0F};
inline const float* TERRAIN_HEIGHTS_TABLES[SCENE_COUNT] = {HM_0_HEIGHTS, HM_1_HEIGHTS, HM_2_HEIGHTS, HM_3_HEIGHTS};

inline const unsigned char* TERRAIN_SPLAT_TABLES[SCENE_COUNT] = {nullptr, nullptr, nullptr, nullptr};
