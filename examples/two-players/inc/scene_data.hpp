...
constexpr SceneObjectData SCENE_0_OBJECTS[8] = {
    {0, {10.0F, 1.5F, 10.0F}, {0.0F, 0.0F, 0.0F}, {1.0F, 3.0F, 1.0F}, {0.85F, 0.3F, 0.25F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 0, 0, 0.65F, "", "", "", "", "", "", 0.08F, 0.35F, 0.75F, 0.12F, 0.22F, 0.35F, 35.0F, 0.1F, 16, 0, -1, 1, {0.0F, 0.0F, 0.0F, 0.0F}},  // pillar-ne
    {0, {-10.0F, 1.5F, 10.0F}, {0.0F, 0.0F, 0.0F}, {1.0F, 3.0F, 1.0F}, {0.25F, 0.5F, 0.9F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 0, 0, 0.65F, "", "", "", "", "", "", 0.08F, 0.35F, 0.75F, 0.12F, 0.22F, 0.35F, 35.0F, 0.1F, 16, 0, -1, 1, {0.0F, 0.0F, 0.0F, 0.0F}},  // pillar-nw
    {0, {10.0F, 1.5F, -10.0F}, {0.0F, 0.0F, 0.0F}, {1.0F, 3.0F, 1.0F}, {0.95F, 0.8F, 0.2F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 0, 0, 0.65F, "", "", "", "", "", "", 0.08F, 0.35F, 0.75F, 0.12F, 0.22F, 0.35F, 35.0F, 0.1F, 16, 0, -1, 1, {0.0F, 0.0F, 0.0F, 0.0F}},  // pillar-se
    {0, {-10.0F, 1.5F, -10.0F}, {0.0F, 0.0F, 0.0F}, {1.0F, 3.0F, 1.0F}, {0.3F, 0.85F, 0.4F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 0, 0, 0.65F, "", "", "", "", "", "", 0.08F, 0.35F, 0.75F, 0.12F, 0.22F, 0.35F, 35.0F, 0.1F, 16, 0, -1, 1, {0.0F, 0.0F, 0.0F, 0.0F}},  // pillar-sw
    {0, {0.0F, 0.75F, 0.0F}, {0.0F, 0.0F, 0.0F}, {6.0F, 1.5F, 0.8F}, {0.6F, 0.6F, 0.65F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 0, 0, 0.65F, "", "", "", "", "", "", 0.08F, 0.35F, 0.75F, 0.12F, 0.22F, 0.35F, 35.0F, 0.1F, 16, 0, -1, 1, {0.0F, 0.0F, 0.0F, 0.0F}},  // wall-mid
    {0, {6.0F, 0.4F, -4.0F}, {0.0F, 0.0F, 0.0F}, {2.0F, 0.8F, 2.0F}, {0.7F, 0.45F, 0.85F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 0, 0, 0.65F, "", "", "", "", "", "", 0.08F, 0.35F, 0.75F, 0.12F, 0.22F, 0.35F, 35.0F, 0.1F, 16, 0, -1, 1, {0.0F, 0.0F, 0.0F, 0.0F}},  // step-e
    {6, {-2.0F, 0.0F, 6.0F}, {0.0F, 180.0F, 0.0F}, {3.0F, 3.0F, 3.0F}, {0.9F, 0.55F, 0.35F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, 0, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 0, 0, 0.65F, "", "", "", "", "", "", 0.08F, 0.35F, 0.75F, 0.12F, 0.22F, 0.35F, 35.0F, 0.1F, 16, 0, -1, 0, {0.0F, 0.0F, 0.0F, 0.0F}},  // player-cat-ginger
    {6, {2.0F, 0.0F, 6.0F}, {0.0F, 180.0F, 0.0F}, {3.0F, 3.0F, 3.0F}, {0.6F, 0.6F, 0.6F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1, 0, 1.0F, 8.0F, 0, 0.0F, 0, 0, 0, 0.0F, 0, 0, 0, 0, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 0, 0, 0.65F, "", "", "", "", "", "", 0.08F, 0.35F, 0.75F, 0.12F, 0.22F, 0.35F, 35.0F, 0.1F, 16, 0, -1, 0, {0.0F, 0.0F, 0.0F, 0.0F}},  // player-cat
};
...
constexpr unsigned long long SCENE_0_OBJECT_ID_HASHES[8] = {0xf7e35d92c6dc1ba7ULL, 0x03e3f52819aec9cdULL, 0xdd02563540f3648cULL, 0x88cafb6926a195efULL, 0xe8a2f5b898415d4cULL, 0x7caec24a859d3babULL, 0xb8cc2f5d310aab42ULL, 0x7fc3c1d71538f910ULL};
...
constexpr int PLAYER2_INDEXES[SCENE_COUNT] = {7};
constexpr int PLAYER2_MODES[SCENE_COUNT] = {2};
constexpr float PLAYER2_WALK_SPEEDS[SCENE_COUNT] = {0.05F};
constexpr float PLAYER2_LOOK_SPEEDS[SCENE_COUNT] = {1.0F};
constexpr float PLAYER2_EYE_HEIGHTS[SCENE_COUNT] = {0.8F};
...
constexpr float PLAYER2_CAM_DISTS[SCENE_COUNT] = {4.0F};
constexpr float PLAYER2_CAM_HEIGHTS[SCENE_COUNT] = {1.0F};
...
constexpr const char* PLAYER2_IDLE_CLIPS[SCENE_COUNT] = {"reference|reference|EmptyAction"};
...
inline const char* SAVE_VALUE_NAMES[SAVE_VALUE_COUNT > 0 ? SAVE_VALUE_COUNT : 1] = {"opt_players"};
