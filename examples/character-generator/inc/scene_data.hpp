...
constexpr SceneObjectData SCENE_0_OBJECTS[4] = {
    {6, {0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {0.15F, 0.9F, 0.9F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 0, 0.0F, 0, 0, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 0},  // player
    {5, {-4.5F, 0.0F, 9.0F}, {0.0F, 205.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {1.0F, 1.0F, 1.0F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 2, 0.0F, 0, 1, "idle", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 0},  // clerk
    {5, {4.5F, 0.0F, 10.0F}, {0.0F, 155.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {1.0F, 1.0F, 1.0F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 2, 0.0F, 0, 2, "idle", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 0},  // dockhand
    {5, {-0.5F, 0.0F, 13.5F}, {0.0F, 180.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {1.0F, 1.0F, 1.0F}, 0, 1.0F, 0.35F, 0.5F, 1, 3.0F, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 2, 0.0F, 0, 3, "idle", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 16, -1, 0},  // kid
};
...
constexpr unsigned long long SCENE_0_OBJECT_ID_HASHES[4] = {0x6daadec0e41ae52dULL, 0x7becbd47c72fdb86ULL, 0x7be2bd47c7278701ULL, 0x7be6bd47c72b6fd8ULL};
...
constexpr float PLAYER_WALK_SPEEDS[SCENE_COUNT] = {0.06F};
...
constexpr float PLAYER_CAM_DISTS[SCENE_COUNT] = {4.5F};
constexpr float PLAYER_CAM_HEIGHTS[SCENE_COUNT] = {1.5F};
...
constexpr const char* PLAYER_IDLE_CLIPS[SCENE_COUNT] = {"idle"};
constexpr const char* PLAYER_WALK_CLIPS[SCENE_COUNT] = {"walk"};
constexpr const char* PLAYER_RUN_CLIPS[SCENE_COUNT] = {"run"};
constexpr const char* PLAYER_JUMP_CLIPS[SCENE_COUNT] = {"jump"};
