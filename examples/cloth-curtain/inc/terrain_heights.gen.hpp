...
constexpr float HM_ORIGIN_XS[SCENE_COUNT] = {-30.0F};
constexpr float HM_ORIGIN_ZS[SCENE_COUNT] = {-30.0F};
constexpr float HM_STEP_XS[SCENE_COUNT] = {1.875F};
constexpr float HM_STEP_ZS[SCENE_COUNT] = {1.875F};
