...
enum { OP_SetObjectVisible = 0, OP_MoveObjectBy = 1, OP_SetObjectColor = 2, OP_SetPosition = 3, OP_MoveObjectTo = 4, OP_TeleportPlayer = 5, OP_SetSky = 6, OP_Delay = 7, OP_Log = 8, OP_SetVarInt = 9, OP_SetVarBool = 10, OP_SetVarPos = 11, OP_SetValue = 12, OP_AddValue = 13, OP_SetTextVisible = 14, OP_SetHudVisible = 15, OP_SwitchScene = 16, OP_SetFog = 17, OP_SetBloom = 18, OP_SetGrain = 19, OP_SetParticles = 20, OP_RotateObjectBy = 21, OP_SetRotation = 22, OP_SpinObject = 23, OP_SetMotionBlur = 24 };
...
void exec(ScriptContext& ctx, const Prog& pr, const Ins& in) {
  ...
  switch (in.op) {
    ...
    case OP_SpinObject:
      ...
      break;
    case OP_SetMotionBlur:
      {
        int v = (int)(in.num[0] * 115.0F + 0.5F);
        ctx.motionBlur = v < 0 ? 0 : (v > 115 ? 115 : v);
      }
      break;
    default: break;
  }
