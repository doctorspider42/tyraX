...
constexpr SceneObjectData SCENE_0_OBJECTS[9] = {
    ...
    {0, {0.0F, 0.0F, 5.0F}, {0.0F, 0.0F, 0.0F}, {16.0F, 0.2F, 11.0F}, {0.42F, 0.45F, 0.5F}, 0, 1.0F, 0.35F, 0.5F, 1, -1, -1, 0, 0, 0, 0, 24, 0.5F, 1, 0, 3.0F, 20.0F, 9.8F, 1.0F, 1.5F, 1.0F, 0.6F, 0, -1, 1, 15.0F, 0.0F, 0, 1.0F, 8.0F, 0, 2, 0.0F, 0, -1, "", 1, 1, 1.0F, -1.0F, -1.0F, 0.0F, 1, -1, 1},  // floor
...
constexpr MirrorData MIRRORS[1] = {
    {0, 1, 0.35F, 1, 0, 4, 1, 128},  // mirror
};
constexpr int MIRROR_TARGETS[4] = {2, 3, 4, 5};
