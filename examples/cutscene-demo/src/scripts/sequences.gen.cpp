...
static const ObjKey kS0T1K[] = {{0.0F, {10.0F, 6.4F, -4.0F}, {0.0F, 0.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {1.0F, 0.85F, 0.4F}, 0, 2}, {9.5F, {10.0F, 6.4F, -4.0F}, {0.0F, 0.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {1.0F, 0.85F, 0.4F}, 1, 2}};  // "sparks" -> scene 0 obj 6
static const ObjKey kS0T2K[] = {{5.0F, {-16.0F, 2.5F, -10.0F}, {8.0F, 0.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {1.0F, 0.6F, 0.3F}, 1, 0}, {10.0F, {14.0F, 2.5F, -10.0F}, {8.0F, 0.0F, 0.0F}, {1.0F, 1.0F, 1.0F}, {1.0F, 0.6F, 0.3F}, 1, 0}};  // "cam-dolly" -> scene 0 obj 9
static const Track kS0Tracks[] = {{0, 2, 1, 1, 0, 0, 0, kS0T0K, 4}, {0, 6, 0, 0, 0, 0, 1, kS0T1K, 2}, {0, 9, 1, 0, 0, 0, 0, kS0T2K, 2}};
