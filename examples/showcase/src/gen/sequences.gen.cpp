...
static const ObjKey kS2T0K[] = {{0.0F, {0.0F, 4.1F, -12.0F}, {0.0F, 0.0F, 0.0F}, {1.7F, 1.7F, 1.7F}, {1.0F, 1.0F, 1.0F}, 1, 1}, {4.0F, {0.0F, 4.1F, -12.0F}, {0.0F, 0.0F, 0.0F}, {2.6F, 2.6F, 2.6F}, {1.0F, 0.95F, 0.7F}, 1, 1}, {8.0F, {0.0F, 4.1F, -12.0F}, {0.0F, 0.0F, 0.0F}, {2.1F, 2.1F, 2.1F}, {0.8F, 1.0F, 1.0F}, 1, 1}};  // "heart-of-aster" -> scene 0 obj 29
static const Track kS2Tracks[] = {{0, 29, 0, 0, 1, 1, 0, kS2T0K, 3}};
...
static const Seq kSeqs[] = {
  {"Arrival", 10.0F, 0, 1, 1, 0, 0, 1, 0, 0.7F, 0.7F, 0.5F, 0.5F, kS0Tracks, 0, kS0Cam, 3}, 
  {"The Grand Tour", 22.0F, 0, 1, 1, 0, 0, 1, 0, 0.7F, 0.7F, 0.5F, 0.5F, kS1Tracks, 0, kS1Cam, 5}, 
  {"Celestial Alignment", 8.0F, 0, 1, 1, 0, 0, 1, 0, 0.7F, 0.7F, 0.5F, 0.5F, kS2Tracks, 1, kS2Cam, 3}
};
