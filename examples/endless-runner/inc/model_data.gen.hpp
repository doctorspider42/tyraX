...
inline const char* MODEL_PATHS[MODEL_COUNT > 0 ? MODEL_COUNT : 1] = {
    "models/procgen-rocksr-rock-x0z0.tmdl",
    "models/procgen-rocksr-pine-x0z0.tmdl",
    "models/procgen-rocksl-rock-xm1z0.tmdl",
    "models/procgen-rocksl-pine-xm1z0.tmdl",
};
...
inline const char* MODEL_SOURCES[MODEL_COUNT > 0 ? MODEL_COUNT : 1] = {
    "res/models/procgen-rocksr-rock-x0z0.obj",
    "res/models/procgen-rocksr-pine-x0z0.obj",
    "res/models/procgen-rocksl-rock-xm1z0.obj",
    "res/models/procgen-rocksl-pine-xm1z0.obj",
};
