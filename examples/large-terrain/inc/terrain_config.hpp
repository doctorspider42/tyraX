...
constexpr int TERRAIN_MAX_CELLS = 512;
...
constexpr float TERRAIN_VIEW_DISTANCE = 100.0F;
...
constexpr float RUN_SPEED = 0.8F;
constexpr float SPRINT_SPEED = 1.44F;
...
constexpr float ANIM_LOD_DISTANCE = 30.0F;
...
constexpr float MESH_LOD_DISTANCE = 22.0F;
