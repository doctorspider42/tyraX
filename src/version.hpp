...
// 1.52.0 (a curved low-poly surface stops shading in steps): the static-model
...
// project data). (Authored as 1.44.0; main took 1.44 through 1.51 - the
// installer/release set - while this branch was open, so the arrive-second
// rule renumbers this entry to the MINOR strictly above both parents.)
//
