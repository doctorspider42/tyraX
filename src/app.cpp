...
void App::drawPreferencesModal() {
    ...
    // this is the biggest single lever on how much VRAM textures get - which
    // is why the help text quotes the actual budget for the selected mode.
    {
        ...
        prefHelp(
            ...
            "buffer. 16-bit (5-5-5-1) HALVES what the two frame buffers cost\n"
            "in GS memory and hands all of it to textures, which roughly\n"
            "DOUBLES the texture budget - the single biggest saving available\n"
            "on a 4 MB GS, and what makes the taller HD scan modes practical.\n"
