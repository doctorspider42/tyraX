...
- **[Cloth and soft bodies](docs/cloth.md)** — a curtain the player walks
  through and leaves swinging. One particle per quadword, constraints in four
  independent batches, the arithmetic on VU0.
...
| [cloth-curtain](examples/cloth-curtain) | A doorway with a curtain in it. Walk through and it lifts around you, then settles |
